    ...
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <div className="space-y-3">
          <h2 className="text-2xl font-semibold tracking-tight text-foreground">Choose Tree</h2>
          <p className="text-muted-foreground leading-relaxed">Select a tree from your farm for leaf analysis</p>
        </div>
      ...
      {loadingTrees ? (
        ...
        <Card>
          <CardContent className="p-16 text-center">
            ...
            <div className="space-y-2">
              <h3 className="text-lg font-semibold">Loading Trees</h3>
              <p className="text-muted-foreground">Please wait while we fetch your trees...</p>
            </div>
          </CardContent>
        </Card>
      ) : trees.length > 0 ? (
        <div className="space-y-4">
                ...
                <CardContent className="p-2">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-foreground text-lg leading-tight">{tree.treeCode}</h3>
                      <p className="text-sm text-muted-foreground ">Tree Identifier</p>
                    </div>
          ...
          >
            ...
            <span className="font-medium">Generate New Tree Code</span>
          </Button>
        </div>
      ) : (
        /* Empty State */
        <Card className="border-dashed border-2">
          <CardContent className="p-12 text-center">
            ...
            <div className="space-y-3 mb-8">
              <h3 className="text-xl font-semibold text-foreground">No Trees Available</h3>
              <p className="text-muted-foreground max-w-sm mx-auto leading-relaxed">
                Generate your first tree code for this farm to get started
              </p>
            </div>
            <Button onClick={onGenerateNewTreeCode} disabled={loadingTrees} size="lg" className="px-8">
