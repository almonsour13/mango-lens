  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        <h2 className="text-2xl font-semibold tracking-tight text-foreground">Select Your Farm</h2>
        <p className="text-muted-foreground leading-relaxed">Choose the farm where you want to analyze leaf samples</p>
      </div>
                ...
                <CardContent className="p-2">
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      <h3 className="font-semibold text-foreground text-lg leading-tight">{farm.farmName}</h3>
                      <p className="text-sm text-muted-foreground leading-relaxed">{farm.address}</p>
                    </div>
        ...
        <Card className="border-dashed border-2">
          <CardContent className="p-12 text-center">
            ...
            <div className="space-y-3 mb-8">
              <h3 className="text-xl font-semibold text-foreground">No Farms Available</h3>
              <p className="text-muted-foreground max-w-sm mx-auto leading-relaxed">
                Get started by adding your first farm to begin leaf analysis
              </p>
            </div>
            <Button onClick={onAddFarmClick} size="lg" className="px-8">
