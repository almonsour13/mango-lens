...
export default function Banner() {
    return (
        <div className="relative">
            <div className="absolute inset-0 h-full w-full bg-gradient-radial from-transparent via-background/80 to-background " />
            <SectionWrapper
                id="Home"
                className="min-h-screen h-auto flex w-full py-16 bg-transparent"
            >
                <div className="flex-1 flex flex-col lg:flex-row">
                    <div className="flex-1 flex flex-col items-start justify-center gap-2">
                        ...
                        <p className="text-muted-foreground">
                            Protect your mango harvest with our disease
                            detection app. Quick, accurate, and easy to use.
                        </p>
